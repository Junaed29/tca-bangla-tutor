---
number: "০৪"
title: "Quest ০৪, প্রথম জাদু: Counter app"
...
তুমি এইমাত্র তোমার প্রথম TCA app চালালে। State আলাদা, Action enum, Reducer-এ decision, Store top-level-এ। এটাই pattern, বদলাবে না।
</Callout>

<Callout type="level-up">
🎉 **Level Up!** তুমি এখন একটা পুরো feature-এর skeleton নিজে দাঁড়াতে পারো। চা-টা শেষ করে পরের quest-এ চলো, এবার ছোট ভাই করিম-কে কাজে লাগাবো।
</Callout>
