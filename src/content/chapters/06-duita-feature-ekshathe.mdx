---
number: "০৬"
title: "Quest ০৬ — দুইটা Feature একসাথে"
...
তুমি একটা parent reducer-এ দুটো child compose করতে শিখলে। বড় app-এ এই pattern বার বার চলে — Scope, Scope, Scope, তারপর একটা ছোট outer Reduce।
</Callout>

<Callout type="level-up">
🎉 **Level Up!** Part ২ শেষ। তুমি এখন একটা ছোট app নিজে দাঁড়িয়ে দাঁড়িয়ে বানাতে পারো। চা refill করো — Part ৩-এ আরো গভীরে যাচ্ছি: navigation, dependency, testing।
</Callout>
