...
Chapters 04–12 all open with Quest-framed titles. Each ends with a Checkpoint + Level Up callout. Game-style callouts (`power-up`, `boss-battle`, `cheat-code`, `mystery`) used naturally throughout — not forced.
